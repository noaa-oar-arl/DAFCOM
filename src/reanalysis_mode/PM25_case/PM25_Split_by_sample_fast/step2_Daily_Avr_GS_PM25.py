...
file_loc = '/Volumes/Ext_Disk_2/Data/gs_data/US/EPA_US/2023/' 
filename = 'daily_88101_2023'
...
# plt.plot(np.array(LON_count), np.array(LAT_count),'r*',label = 'EPA pm2.5 sites')
...
# plt.savefig('CONUS_US_map_PM25_sites.png', dpi = 300)
