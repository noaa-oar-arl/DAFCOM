...
'''
dir_cams = '/Volumes/Ext_Disk_1/3_NOAA_projects/NOAA_UFS_downscale/data/1_MODIS_AOD/1_prepare_CAMS_AOD/'
...
Julian_day_list =['0601'] 
Day_index_list =[0]

for kk in range(len(Julian_day_list)):
    dir_ = '/Volumes/Ext_Disk_1/3_NOAA_projects/NOAA_UFS_downscale/data/1_MODIS_AOD/2_prepare_MAIAC_AOD/'
