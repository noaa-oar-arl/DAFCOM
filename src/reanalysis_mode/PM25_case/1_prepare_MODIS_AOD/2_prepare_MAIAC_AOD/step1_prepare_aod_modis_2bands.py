...
date_input = '1101' #change here
'''
1) read in land-use .tif data
'''
dir_1 = '/Volumes/Ext_Disk_2/Data/satellite_data/MODIS_MAIAC_AOD/2018_11_CONUS_US/'

pattern1 = date_input+'/'+date_input+'_aod_1.tif' 
filename1 = dir_1 + pattern1

pattern2 = date_input+'/'+date_input+'_aod_2.tif' 
...
img_sum = np.concatenate((img1_nlayer, img2_nlayer), axis = 0)
