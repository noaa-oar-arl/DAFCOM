...
'''
dir_1 = './'
ds = xr.open_dataset(dir_1+'Population_step1_data.nc')
...
ft = Dataset(('Population_0p01_regrid_data.nc'),'w',format = 'NETCDF4')   
...
variable_new_nc = ft.createVariable('Population','f4',('time','latitude','longitude'))  
