...
variable_name = 'Elevation'  #change here
'''
1) read inputs
'''
dir_1 = '/Volumes/Ext_Disk_1/2_GMU_projects/1_GMU_20year_run/CONUS_US/data_CONUS_US/4_elevation/step3_combine/'
ds = xr.open_dataset(dir_1+'Elevation_0p01_regird.nc')
...
ft = Dataset(('elevation_final_regrid_0p01.nc'),'w',format = 'NETCDF4')   
