...
V1_BLH, V2_D2M,V3_E, V4_SP, V5_T2M, V6_TP, V7_U10, V8_V10, V9_AOD, V10_NDVI, V11_LAND_USE_COVER,V12_ELEVATION,V13_POPULATION, V14_CMAQ_PM25,V18_E_BC, V19_E_SO2, V20_E_NOX, V21_E_VOC, V22_E_NH3, V23_E_PM25, EPA_PM25,LOC_NUMBER,LAT, LON, D1, D2, D3, D4, D5,JULIAN_DAY = GetData('CONUS_US_interpolated_June2023')
