...
plt.savefig('Bay_Area_compare_1stHalf5sites_withAOD',dpi = 600)
...
ax6 = plt.subplot(6,1,6)
ax6.xaxis.set_major_formatter(myFmt)
plt.plot(TIME_OBS_site12,PM25_OBS_site12,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[11]))
...
plt.savefig('Bay_Area_compare_2ndHalf6sites_withAOD',dpi = 600)