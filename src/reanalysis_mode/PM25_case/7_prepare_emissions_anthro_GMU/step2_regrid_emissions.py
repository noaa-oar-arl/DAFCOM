...
variable_name = 'E_voc'  #CHANGE 1
'''
1) read inputs
'''
dir_1 = '/Volumes/Ext_Disk_1/2_GMU_projects/1_GMU_20year_run/CONUS_US/data_CONUS_US/7_emission_anthro_gmu_1km/step1/'
ds = xr.open_dataset(dir_1+'Emission_VOC_step1.nc')   #CHANGE 2
...
ft = Dataset((variable_name+'_0p01_regrid_data.nc'),'w',format = 'NETCDF4')   
