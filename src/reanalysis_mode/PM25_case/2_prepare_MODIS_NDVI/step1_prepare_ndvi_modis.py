...
'''
dir_1 = '/Volumes/Ext_Disk_2/Data/satellite_data/MODIS_NDVI/MODIS_NDVI_2023_06_CONUS_US/'

pattern1 = '0618_ndvi_aqua.tif' #change here
filename1 = dir_1 + pattern1

pattern2 = '0626_ndvi_terra.tif' #change here
...
ft = Dataset(('NDVI_step1_0615'+'.nc'),'w',format = 'NETCDF4')   #change here
