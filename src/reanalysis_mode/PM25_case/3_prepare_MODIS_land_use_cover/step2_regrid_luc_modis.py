...
'''
dir_1 = './'
ds = xr.open_dataset(dir_1+'LUC_step1_data.nc') #change here

dr = ds['luc']  #change here
'''
...
ft = Dataset(('LUC_0p01_regrid_data.nc'),'w',format = 'NETCDF4')    #change here
...
variable_new_nc = ft.createVariable('luc','f4',('time','latitude','longitude'))  #change here
