...
'''
dir_1 = '/Volumes/Ext_Disk_2/Data/reanalysis_data/ERA-Interim_meteo_data/2023_US_CONUS/'
f1 = xr.open_dataset(dir_1+'LandOnly_0p01.nc')
...
variable_land_combine = variable_land_1
#stay time 2018-nov
...
'''
dir_3 = '/Volumes/Ext_Disk_2/Data/reanalysis_data/ERA-Interim_meteo_data/2023_US_CONUS/'
f3 = xr.open_dataset(dir_1+'LandAndOcean_0p25.nc')
...
ds_out =xr.Dataset(
    {
        "lat": (["lat"], np.arange(49, 25-0.10, -0.10), {"units": "degrees_north"}),
...
'''
variable_final = np.zeros((720,241,601))
...
lat_new = [49- 0.10*X for X in range(241)]
...
nlat = ft.createDimension('latitude',241)
