...
'''
dir_1 = './'
ds = xr.open_dataset(dir_1+'step1_data_NO2.nc')
...
ft = Dataset(('CMAQ_0p01_regrid_data.nc'),'w',format = 'NETCDF4')   
...
variable_new_nc = ft.createVariable('no2','f4',('time','latitude','longitude'))  
