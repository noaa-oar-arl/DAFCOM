...
V1 = f1.variables[name_variable1][:][0][0] #(3177,5397)
V2 = f1.variables[name_variable2][:][0][0] #(3177,5397)
...
Emission_Korea = V1*Mw1*3600*24/(1000)+ V2*Mw2*3600*24/(1000)
...
3)write in netcdf
'''
ft = Dataset('Emission_NOx_step1.nc','w',format = 'NETCDF4')                   #Change2
...
variable_new = ft.createVariable('E_nox','f4',('time','latitude','longitude')) #Change3
variable_new .units =''                                               
