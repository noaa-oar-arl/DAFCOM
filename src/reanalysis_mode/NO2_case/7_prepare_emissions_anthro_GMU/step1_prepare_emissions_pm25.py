...
name_variable_list = ['PEC','PNO3','POC','PSO4','PAL',
                      'PCA','PCL','PFE','PH2O','PK',
                      'PMG','PMN','PMOTHR','PNA','PNH4',
                      'PNCOM','PSI','PTI','PMC']
'''
...
3)write in netcdf
'''
ft = Dataset('Emission_PM25_step1.nc','w',format = 'NETCDF4')                   #Change2
...
variable_new = ft.createVariable('E_pm25','f4',('time','latitude','longitude')) #Change3
variable_new .units =''                                               
