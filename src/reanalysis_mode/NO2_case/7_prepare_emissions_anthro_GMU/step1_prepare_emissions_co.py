...
'''
1-2) check if we have some value <0
'''
print(np.min(V1))
...
Emission_Korea = V1*Mw*3600*24/(1000)  #convert unit from mol/s to kg/day
...
print(len(LON_list[0]))
'''
3)write in netcdf
'''
ft = Dataset('Emission_CO_step1.nc','w',format = 'NETCDF4')                   #Change2
...
variable_new = ft.createVariable('E_co','f4',('time','latitude','longitude')) #Change3
variable_new .units =''                                               
