...
1) read inputs
'''
dir_1 = '/Volumes/Ext_Disk_1/2_GMU_projects/1_GMU_20year_run/CONUS_US/NO2_Case/data_CONUS_US/8_TROPOMI_NO2/'
ds = xr.open_dataset(dir_1+'NO2_TROP_2018'+dateinput+'.nc') 
