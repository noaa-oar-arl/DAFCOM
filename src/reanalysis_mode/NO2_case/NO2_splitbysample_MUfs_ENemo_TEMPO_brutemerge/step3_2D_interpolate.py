...
from step2_Daily_Avr_GS_NO2 import LOC_NUMBER_OBS_FINAL, PM_OBS_FINAL, TIME_OBS_FINAL,LAT_OBS_FINAL,LON_OBS_FINAL

print(np.shape(BLH))
print(np.shape(PM_OBS_FINAL))
...
sheet1.write(0,18,'V14_CMAQ_NO2')
sheet1.write(0,19,'V15_MERGE_NO2')
sheet1.write(0,20,'V16_TROPOMI_NO2')
...
# sheet1.write(0,28,'V24_FIRE_EMIS_PM25')
...
wb.save('CONUS_US_interpolated_Aug2023_NO2.xls')
