...
EPA_PM25_domain,LOC_NUMBER_domain,LAT_domain, LON_domain,TIME_domain= GetData(38.8,39.0,-77.13,-76.9) #this is dc
...
plt.ylabel('NO2 (ppbv)',fontsize = 20)
plt.legend(loc = 'upper right',fontsize = 20)
plt.savefig('DC_compare_5sites_withAOD',dpi = 600)