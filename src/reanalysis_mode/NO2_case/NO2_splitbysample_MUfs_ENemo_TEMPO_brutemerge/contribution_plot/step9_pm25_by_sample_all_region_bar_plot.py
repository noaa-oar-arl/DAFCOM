...
Input_list = ['BLH','D2m', 'Evaporation', 'SP', 'T2m',
              'Precipitation', 'Wind-u','Wind-v', 'TEMPO NO2','AOD', 'NDVI', 
...
pm25_sample_2016WM_base=[2,2,1,2,1,
                         1,2,2,4,1,2,
                         9,2,5,13,7,
                         2,5,14,2,2,
                         13,1]
...
plt.bar(positions1 ,v1,width =0.5,label='2023 Aug NO$_2$',color='#ff7f00')
