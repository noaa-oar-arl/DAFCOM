...
def GetData(ll_lat,ur_lat,ll_lon,ur_lon):
    file_loc = '/Volumes/Ext_Disk_1/2_GMU_projects/1_GMU_20year_run/CONUS_US/NO2_Case/code_CONUS_US/PM25_split_by_sample_MCMAQ_EGMU_AOD/'
    filename = 'CONUS_US_interpolated_Nov2018_NO2'
...
# EPA_PM25_domain,LOC_NUMBER_domain,LAT_domain, LON_domain= GetData(39.65,39.80,-105.05,-104.9) #this is Denver
...
PM25_OBS_site6 = EPA_PM25_formal[5][0:30]
PM25_OBS_site7 = EPA_PM25_formal[6]
PM25_OBS_site8 = EPA_PM25_formal[7]
PM25_OBS_site9 = EPA_PM25_formal[8]
PM25_OBS_site10 =EPA_PM25_formal[9]
PM25_OBS_site11 = EPA_PM25_formal[10]
PM25_OBS_site12 = EPA_PM25_formal[11]
PM25_OBS_site13 = EPA_PM25_formal[12]
PM25_OBS_site14 = EPA_PM25_formal[13][0:30]
...
TIME_OBS_site6 = Time_formal[5][0:30]
TIME_OBS_site7 = Time_formal[6]
TIME_OBS_site8 = Time_formal[7]
TIME_OBS_site9 = Time_formal[8]
TIME_OBS_site10 =Time_formal[9]
TIME_OBS_site11 = Time_formal[10]
TIME_OBS_site12 = Time_formal[11]
TIME_OBS_site13 = Time_formal[12]
TIME_OBS_site14 = Time_formal[13][0:30]

'''
2-1) read in ML prediction data
'''

dir_ml = '/Volumes/Ext_Disk_1/2_GMU_projects/1_GMU_20year_run/CONUS_US/NO2_Case/code_CONUS_US/PM25_split_by_sample_MCMAQ_EGMU_AOD/'
pattern_ml = 'CONUS_US_surfaceNO2_0p01_regird.nc'
...
PM25_ML = fml.variables['Surface no2'][:] #(30,2500,3500)
...
PM25_ML_site6 = GetML(Lon_bystation[5],Lat_bystation[5])
PM25_ML_site7 = GetML(Lon_bystation[6],Lat_bystation[6])
PM25_ML_site8 = GetML(Lon_bystation[7],Lat_bystation[7])
PM25_ML_site9 = GetML(Lon_bystation[8],Lat_bystation[8])
PM25_ML_site10 = GetML(Lon_bystation[9],Lat_bystation[9])
PM25_ML_site11 = GetML(Lon_bystation[10],Lat_bystation[10])
PM25_ML_site12 = GetML(Lon_bystation[11],Lat_bystation[11])
PM25_ML_site13 = GetML(Lon_bystation[12],Lat_bystation[12])
PM25_ML_site14 = GetML(Lon_bystation[13],Lat_bystation[13])
...
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
plt.plot(TIME_OBS_site6,PM25_OBS_site6,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[5]))
plt.plot(TIME_ML_all_site,PM25_ML_site6,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = True, bottom = True)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
plt.plot(TIME_OBS_site7,PM25_OBS_site7,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[5]))
plt.plot(TIME_ML_all_site,PM25_ML_site7,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = True, bottom = True)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
plt.savefig('Bay_Area_compare_1stHalf7sites_withAOD',dpi = 600)


'''
4-2) 2nd half 6 sites
'''
plt.rc('ytick', labelsize=20)
plt.rc('xtick', labelsize=20)
...
ax1 = plt.subplot(7,1,1)
ax1.xaxis.set_major_formatter(myFmt)
plt.plot(TIME_OBS_site8,PM25_OBS_site8,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[0]))
plt.plot(TIME_ML_all_site,PM25_ML_site8,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = False, bottom = False)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
ax2 = plt.subplot(7,1,2)
ax2.xaxis.set_major_formatter(myFmt)
plt.plot(TIME_OBS_site9,PM25_OBS_site9,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[1]))
plt.plot(TIME_ML_all_site,PM25_ML_site9,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = False, bottom = False)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
ax3 = plt.subplot(7,1,3)
ax3.xaxis.set_major_formatter(myFmt)
plt.plot(TIME_OBS_site10,PM25_OBS_site10,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[2]))
plt.plot(TIME_ML_all_site,PM25_ML_site10,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = False, bottom = False)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
ax4 = plt.subplot(7,1,4)
ax4.xaxis.set_major_formatter(myFmt)
plt.plot(TIME_OBS_site11,PM25_OBS_site11,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[3]))
plt.plot(TIME_ML_all_site,PM25_ML_site11,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = False, bottom = False)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
ax5 = plt.subplot(7,1,5)
ax5.xaxis.set_major_formatter(myFmt)
plt.plot(TIME_OBS_site12,PM25_OBS_site12,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[4]))
plt.plot(TIME_ML_all_site,PM25_ML_site12,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = True, bottom = True)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
ax6 = plt.subplot(7,1,6)
ax6.xaxis.set_major_formatter(myFmt)
plt.plot(TIME_OBS_site13,PM25_OBS_site13,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[5]))
plt.plot(TIME_ML_all_site,PM25_ML_site13,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = True, bottom = True)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
ax7 = plt.subplot(7,1,7)
ax7.xaxis.set_major_formatter(myFmt)
plt.plot(TIME_OBS_site14,PM25_OBS_site14,'k*',label = 'EPA OBS @ site '+str(Location_number_bystation[5]))
plt.plot(TIME_ML_all_site,PM25_ML_site14,'r-',label = 'ML prediction')
plt.tick_params(labelbottom = True, bottom = True)
plt.xlim(dt(2018,11,1,0,0,0),dt(2018,12,1,0,0,0))
plt.ylim(0,50)
plt.ylabel('NO2 (ppbv)',fontsize = 20)
...
plt.savefig('Bay_Area_compare_2ndHalf7sites_withAOD',dpi = 600)
