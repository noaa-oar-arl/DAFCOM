...
'''
print('0 meteo')
dir_ = '/Volumes/Ext_Disk_1/3_NOAA_projects/NOAA_UFS_downscale/NO2_case/data/'

pattern_0 = '0_meteo/step2_0p01_fast/meteo_blh_0p01.nc'
...
print('1 aod')
AOD = []
days_list = ['0801','0802','0803','0804','0805','0806','0807','0808','0809','0810',
             '0811','0812','0813','0814','0815','0816','0817','0818','0819','0820',
             '0821','0822','0823','0824','0825','0826','0827','0828','0829','0830',
             '0831']

for i in range(len(days_list)):    
    pattern_9 = '1_MODIS_AOD/4_regriding_final_AOD_fast/final_AOD_regrid_0p01_'+str(days_list[i])+'.nc'
...
print('2 ndvi')
NDVI = []
days_list = [213+X for X in range(31)]
for i in range(len(days_list)):
    if days_list[i] < 228:
        pattern_10 = '2_MODIS_NDVI/step2_regrid_0p01/NDVI_0p01_regrid_0801.nc'
        ...
        pattern_10 = '2_MODIS_NDVI/step2_regrid_0p01/NDVI_0p01_regrid_0815.nc'
        filename_10 = dir_ + pattern_10
        f10 = Dataset(filename_10,'r')
        ndvi = f10.variables['ndvi'][:][0]
        NDVI.append(ndvi)   
...
'''
6) This section is for CMAQ Result as input
'''  
print('6 UFS-AQM')  
pattern_14 = '6_UFS_AQM_NO2/UFS_AQM_0p01_regrid_data.nc'
filename_14 = dir_+ pattern_14
f14 = Dataset(filename_14,'r')

CMAQ_no2_daily = f14.variables['no2'][:] 
# print('CAMS PM25',np.shape(CAMS_pm25_daily))    



'''
7) edgar 2019 emissions
'''
...
for i in range(len(days_list)):    
    pattern_24 = '8_TEMPO_NO2/step5_merge_tempo_tropomi_no2_0p01/merge_no2_trop_regrid_0p01_'+str(days_list[i])+'.nc'
    filename_24 = dir_ + pattern_24
    f24 = Dataset(filename_24,'r')
    merge_no2 = f24.variables['trop_no2'][:][0]
    MERGE_NO2.append(merge_no2)
print('merge_no2', np.shape(MERGE_NO2))     
    
'''
12)Tropomi no2 column
'''
print('12 tropomi no2')
TROPOMI_NO2 = []
days_list = ['0801','0802','0803','0804','0805','0806','0807','0808','0809','0810',
             '0810','0812','0813','0814','0815','0816','0817','0818','0819','0820',
             '0821','0822','0823','0824','0825','0826','0827','0828','0829','0830',
             '0831']

for i in range(len(days_list)):    
    pattern_25 = '8_TROPOMI_NO2/step2_final_regrid_0p01/final_NO2_TROP_regrid_0p01_'+str(days_list[i])+'.nc'
    filename_25 = dir_ + pattern_25
    f25 = Dataset(filename_25,'r')
    tropomi_no2 = f25.variables['final_no2_trop'][:][0]
    TROPOMI_NO2.append(tropomi_no2)
print('tropomi_no2', np.shape(TROPOMI_NO2))         
