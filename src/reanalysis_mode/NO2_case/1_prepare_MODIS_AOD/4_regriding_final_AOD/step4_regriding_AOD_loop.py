...
dateinput_list = [       '0802','0803','0804','0805','0806','0807','0808','0809','0810',
...
for dateinput in dateinput_list:
    ...
    1) read inputs
    '''
    dir_1 = '/Volumes/Ext_Disk_1/3_NOAA_projects/NOAA_UFS_downscale/NO2_case/data/1_MODIS_AOD/3_CAMS&KNN_AOD_filling_fast/'
    ds = xr.open_dataset(dir_1+'AOD_fill_KNN&CAMS_'+dateinput+'.nc') 
    
    dr = ds['AOD_fill_knn&CAMS']  
    '''
