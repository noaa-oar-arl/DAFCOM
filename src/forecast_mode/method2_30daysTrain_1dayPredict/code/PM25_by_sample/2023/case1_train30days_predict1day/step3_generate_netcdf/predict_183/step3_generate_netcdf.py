...
'''
date = '183'   #182-212 is 2023/07, 213 to 243 is 2023/08
date_index = 1

dir_model = '/groups/ESS/btang6/Projects/NOAA/Forecast_UFS/method2_30daysTrain_1dayPredict/code/PM25_by_sample/2023/case1_train30days_predict1day/step2_machine_learning/predict_'+date+'/'
loaded_rf = joblib.load(dir_model+'rf_predict_'+date+'.joblib')
