...
'''
# print('no2 get')
dir_ = '/Users/beiming_tang/Desktop/AGU2024/code/2_NOAA_forecast/Visualize_UFS/'

pattern_0 = 'UFS_PM25_202307.nc'
filename_0 = dir_ + pattern_0
f0 = Dataset(filename_0,'r')
LAT_ml = f0.variables['lat'][:] 
LON_ml = f0.variables['lon'][:] 
...
for i in range(len(V_month_avr)):
    for j in range(len(V_month_avr[0])):
        lon_local = LON_ml[i][j]
        lat_local = LAT_ml[i][j]
...
def GetData(filename):
    file_loc = '/Users/beiming_tang/Desktop/AGU2024/code/2_NOAA_forecast/Visualize_UFS/'
...
EPA_PM25,LOC_NUMBER,LAT, LON,= GetData('CONUS_US_interpolated_2023_183_212_PM25')
Y =  EPA_PM25
...
# m.pcolor(LON_ml, LAT_ml, V_month_avr,vmin =7, vmax = 15,cmap = 'jet')
...
# fig = plt.subplots(1,1,figsize = (18,10))
# m.pcolor(LON_ml, LAT_ml, V_month_avr,vmin =5, vmax =18,cmap = 'jet')
...
# plt.savefig('UFS_PM25_NYC_.png', dpi = 600)
...
dir_shapefile='/Volumes/Ext_Disk_2/Data/shapefiles/USA/USA_County/'
m.readshapefile(dir_shapefile+"tl_rd22_us_county",'US_states')
plt.savefig('NO_SEA_conus.png', dpi = 600)       
