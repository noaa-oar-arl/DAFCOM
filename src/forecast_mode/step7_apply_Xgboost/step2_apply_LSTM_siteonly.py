...
1) load LSTM model
'''
dir_lstm ='/data/aqf3/beiming.tang/DAFCOM/code/step4_train_LSTM/IncludeJulianDay/Exclude_Spatial/Log_PM25/'
...
dir_csv = '/data/aqf3/beiming.tang/DAFCOM/code/step7_apply_Xgboost/site_only/'
pattern_csv = 'PM25_2025_May01to07_HourlyData_LOG.csv'
