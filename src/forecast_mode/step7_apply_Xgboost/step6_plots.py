...
x,y = m2(lon, lat)
sc = m2.scatter(x,y, c= bias_lstm_pm25, cmap='coolwarm',s=30,edgecolors='k',vmin = -10, vmax = 10)
plt.colorbar(sc, label = 'predict bias',orientation='horizontal')

axs[1].set_title ('PM2.5 bias (LSTM - obs)\n'+file_name)
...
plt.savefig(file_name+'_predict_bias_pm25.png',dpi = 600)
