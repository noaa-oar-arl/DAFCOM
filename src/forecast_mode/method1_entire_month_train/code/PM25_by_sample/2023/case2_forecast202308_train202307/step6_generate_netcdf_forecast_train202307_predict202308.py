...
'''
dir_ = '/groups/ESS/btang6/Projects/NOAA/Forecast_UFS/method1_entire_month_train/code/PM25_by_sample/2023/2023_07/'
loaded_rf = joblib.load(dir_+'rf_train_2023_07.joblib')
'''
...
ft = Dataset(('forecast202308_train202307_pm25_0p01'+'.nc'),'w',format = 'NETCDF4')   
