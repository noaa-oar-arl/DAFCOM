...
def GetData(filename):
    file_loc = '/groups/ESS/btang6/Projects/NOAA/Forecast_UFS/method1_entire_month_train/code/PM25_by_sample/2023/2023_07/step8_evaluate_forecast_result/'  #change here
    ...
    V2_Forecast_PM25_train202306_predict202307 = list(obs_df['V2_Forecast_PM25_train202306_predict202307'])  #change here
    
    return LOC_NUMBER,EPA_OBS_PM25,V1_UFS_AQM_PM25,V2_Forecast_PM25_train202306_predict202307  #change here


LOC_NUMBER,EPA_OBS_PM25,V1_UFS_AQM_PM25,V2_Forecast_PM25_train202306_predict202307 = GetData('Evaluate_PM25_2023_07_forecast_vs_OBS') #change here
...
X1 = EPA_OBS_PM25
X2 = V2_Forecast_PM25_train202306_predict202307  #Change here
X3 = V1_UFS_AQM_PM25
