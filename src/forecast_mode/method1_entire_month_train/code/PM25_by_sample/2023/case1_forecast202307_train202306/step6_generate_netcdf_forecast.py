...
'''
dir_ = '/groups/ESS/btang6/Projects/NOAA/Forecast_UFS/method1_entire_month_train/code/PM25_by_sample/2023/2023_06/'
loaded_rf = joblib.load(dir_+'rf_train_2023_06.joblib')
'''
...
ft = Dataset(('forecast202307_train202306_pm25_0p01'+'.nc'),'w',format = 'NETCDF4')   
