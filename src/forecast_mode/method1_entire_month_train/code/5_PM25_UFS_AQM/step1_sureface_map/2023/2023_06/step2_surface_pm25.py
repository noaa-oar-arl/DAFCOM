...
ft = Dataset(('Surface_Map_'+"pm25.nc"),'w',format = 'NETCDF4')                # change chemicals name here
...
vmrno2 = ft.createVariable('pm25','f4',('ntime','nlat','nlon'))                # change chemicals name here
vmrno2.units ='ug/m^3'                                                         # change unit here
vmrno2.description =''
...
for i in range(len(filelist)):
    ...
    vmrno2_w= f.variables['pm25'][0,:]                                       #change chemical variables here
