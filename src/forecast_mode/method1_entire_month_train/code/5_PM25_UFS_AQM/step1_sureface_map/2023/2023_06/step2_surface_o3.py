...
ft = Dataset(('Surface_Map_'+"o3.nc"),'w',format = 'NETCDF4')                # change chemicals name here
...
vmrno2 = ft.createVariable('o3','f4',('ntime','nlat','nlon'))                # change chemicals name here
...
for i in range(len(filelist)):
    ...
    vmrno2_w= f.variables['o3'][0,:]                                       #change chemical variables here
