...
dir_1 = '/groups/ESS/btang6/Projects/NOAA/Forecast_UFS/method1_entire_month_train/data/1_prepare_aod_gefs/step3_daily_avr/2023/2023_06/'
...
ft = Dataset(('GEFS_0p01_'+variable+'.nc'),'w',format = 'NETCDF4')   
