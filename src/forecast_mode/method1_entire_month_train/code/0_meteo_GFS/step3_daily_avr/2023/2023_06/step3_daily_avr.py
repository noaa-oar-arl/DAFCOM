...
varibale_name_list=['evaporation','pblh','precipitation','specific_humidity_2m',
                    'surface_pressure','t2m','u10','v10']

for varibale in varibale_name_list:
    dir_1  = '/groups/ESS/btang6/Projects/NOAA/Forecast_UFS/method1_entire_month_train/data/0_prepare_meteo_GFS/step2_surface_map/2023/2023_06/'
    ...
    nlat = ft.createDimension('latitude',1536)
    nlon = ft.createDimension('longitude',3072)
